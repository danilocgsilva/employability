...
trait FormsDark
{
    ...
    {
        $classes = "w-full transition-all placeholder-gray-400 pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:border-transparent bg-autofill {$this->getTextMain()} {$this->getBackground2()}";
        if ($error) {
